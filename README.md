...
during the R user group. Feel free to peruse the index or search for
posts using the GitHub search functionality.

Each topic has two files: a `.qmd` (Quarto) file and a `.md` (markdown)
file. The `.md` file is rendered from the `.qmd` file. If you look
through the `quarto-markdowns` folder you’ll see one of each file for
each topic.
...
| Date | Script |
|----|----|
| 2026-05-28 | [table package comparison](https://github.com/San-Mateo-County-Health-Epidemiology/R-User-Group/blob/main/quarto-markdowns/table-formatting-comparison.md) |
...
| 2025-05-29 | [API basics](https://github.com/San-Mateo-County-Health-Epidemiology/R-User-Group/blob/main/quarto-markdowns/api-basics.md) |
...
| 2023-08-03 | [identifying episode dates](https://github.com/San-Mateo-County-Health-Epidemiology/R-User-Group/blob/main/quarto-markdowns/identifying-episode-dates.md) |
...
| 2022-10-06 | [comparing code running time](https://github.com/San-Mateo-County-Health-Epidemiology/R-User-Group/blob/main/quarto-markdowns/compare-code-running-time.md) |
...
If you’d like to add your R User Group presentation to this repo, please
follow these steps:
