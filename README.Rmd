...
`format: gfm` tells R the output should be a "GitHub Flavored Markdown". A GFM is a basic HTML output, so some features (like including tab sets) aren't available but it generally meets our needs. It will generate a `.md` (markdown) file that is the rendered version of the Quarto doc. 
