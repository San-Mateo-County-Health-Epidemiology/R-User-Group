...
It’s important to update both your R software and your R Studio IDE
...
Updating R and R Studio involves downloading new versions of R and R
Studio and installing the packages you need. If possible, you should do
the steps in the order below as it will ensure that your new R Studio
...
2.  Install packages in your new version of R.
    - If you have admin rights you should do this in the actual R
      ...
      have admin rights, you can do this in the R or R Studio
      application.
    - To get to the R application go to C:Files. Open the folder with
      your new installation of R (ex: R-4.5.0) and go to the **bin**
      folder. Right click on the **R.exe** application and run it as an
      administrator.  
    - We have a
...
Note: R and R Studio updates aren’t released on the same schedule. It’s
fine to do steps 1 and 2 at a different time than step 3.
