...
`set.seed()` ensures that each person running the code has the same 'randomness' and results that you have when you run it. More information [here](https://www.statology.org/set-seed-in-r/). 
