---
format: gfm
title: "`stat` distribution functions"
author: "Beth Jump"
date: "2025-07-24"
execute: 
  warning: false
...
Here we'll go through four functions that you can use with normal distributions. There are corollaries of these functions for other distributions including: binomial, uniform, exponential, gamma, F, Cauchy, etc.
