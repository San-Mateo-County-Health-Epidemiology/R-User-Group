...
For examples of rendering scripts, see: "r-scripts/render_parameters_example_basic.R" & "r-scripts/render_parameters_example_loop.R"
...
-   You can reference parameters in the report title like this:
    ...
    -   `params` must be defined BEFORE any element in the yalm that references it
