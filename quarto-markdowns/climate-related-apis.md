...
```
    ...
    $ name                       <chr> "This Afternoon", "Tonight", "Wednesday", "…
    $ startTime                  <chr> "2025-09-30T14:00:00-07:00", "2025-09-30T18…
    $ endTime                    <chr> "2025-09-30T18:00:00-07:00", "2025-10-01T06…
    $ isDaytime                  <lgl> TRUE, FALSE, TRUE, FALSE, TRUE, FALSE, TRUE…
    $ temperature                <int> 77, 62, 76, 59, 76, 57, 78, 56, 79, 56, 79,…
    $ temperatureUnit            <chr> "F", "F", "F", "F", "F", "F", "F", "F", "F"…
    $ temperatureTrend           <chr> "", "", "", "", "", "", "", "", "", "", "",…
    $ probabilityOfPrecipitation <df[,2]> <data.frame[14 x 2]>
    $ windSpeed                  <chr> "12 mph", "5 to 8 mph", "5 to 8 mph", "2…
    $ windDirection              <chr> "SW", "S", "S", "WSW", "WNW", "WNW", "WNW",…
    $ icon                       <chr> "https://api.weather.gov/icons/land/day/sct…
    $ shortForecast              <chr> "Mostly Sunny", "Chance Drizzle", "Chance D…
    $ detailedForecast           <chr> "Mostly sunny. High near 77, with temperatu…
...
```
    ...
    $ max_temp_f                   <int> 77, 76, 76, 78, 79, 79, 78
    $ min_temp_f                   <int> 62, 59, 57, 56, 56, 57, 57
    $ probability_of_precipitation <df[,2]> <data.frame[7 x 2]>
    $ wind_speed                   <chr> "12 mph", "5 to 8 mph", "2 to 14 mph", "3…
    $ wind_direction               <chr> "SW", "S", "WNW", "WNW", "W", "WSW", "SW"
    $ short_forecast               <chr> "Mostly Sunny", "Chance Drizzle", "Mostly…
    $ detailed_forecast            <chr> "Mostly sunny. High near 77, with temp…
...
```
    ...
    Rows: 7
    Columns: 52
    $ id                             <chr> "1023575107", "1023574080", "1023242473…
    ...
    $ temporal                       <chr> "20251002", "20251004", "20251005", "20…
    ...
    $ temporal_id                    <int> 20251002, 20251004, 20251005, 20250930,…
...
```
    ...
    Rows: 7
    Columns: 5
    $ date            <date> 2025-09-30, 2025-10-01, 2025-10-02, 2025-10-03, 2025-…
