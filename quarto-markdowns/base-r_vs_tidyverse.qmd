...
Base R involves coding with only the functions that are native to R while tidyverse is a set of packages that need to be installed and don't come with the "base" installation of R.
