...
Then, calculate the standard error, which is the standard deviation of the sampling distribution

Next, calculate the margin of error, which represents the amount of random sampling error
...
Finally, calculate the lower and upper confidence intervals and multiply by designated multiplier (e.g., 100,000).
