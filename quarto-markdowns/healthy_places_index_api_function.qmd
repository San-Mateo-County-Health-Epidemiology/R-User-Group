...
## Inputs to download and clean datasets for HPI and section scores

The HPI calculates a main HPI score, as well as scores for each of the sub-domains. Here, we create indicator and year vectors that are relevant to those scores, as labeled throughout the following code chunk.
