...
Here we are calculating the probability of seeing a z-score of -2 or less than -2 on a normal distribution centered at 0 with a standard deviation of 1: 

```{r}
pnorm(-2)
```

Here we are calculating the probability of seeing a z-score of 1 or less than 1 on a normal distribution centered at 0 with a standard deviation of 1: 
```{r}
pnorm(1)
```

If we wanted the probability of seeing a z-score of 1 or greater on 
