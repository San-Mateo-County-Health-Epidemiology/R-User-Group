...
This doesn't work because you're not accounting for tidy evaluation. You're referencing the `grouping_var` as if it were an object in your enviroment when it's not - it's a subset of an object. 
