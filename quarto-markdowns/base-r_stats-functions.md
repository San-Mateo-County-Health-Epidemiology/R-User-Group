# Base R statistics-related functions
Beth Jump
2025-06-26
...
![](base-r_stats-functions_files/figure-commonmark/unnamed-chunk-3-1.png)
...
In the `stats` package, there are some very useful functions for working
with normal distributions. Note that corollaries of these functions also
exist for other distributions including: binomial, uniform, exponential,
gamma, F, Cauchy, etc.
...
![](base-r_stats-functions_files/figure-commonmark/unnamed-chunk-7-1.png)
...
![](base-r_stats-functions_files/figure-commonmark/unnamed-chunk-8-1.png)
